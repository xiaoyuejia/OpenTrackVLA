...
def parse_args() -> argparse.Namespace:
    ...
    ap.add_argument(
        ...
        type=str,
        required=True,
        help="Raw collection root, e.g. /data/hdt/ntv_data/sim_data/stt_train",
    )
    ap.add_argument(
        "--output_root",
        type=str,
        default=None,
        help="Processed dataset root, e.g. /data/hdt/ntv_data/data/sample. If present, counts actual jsonl samples when available.",
    )
