...
DATA_ROOT="${DATA_ROOT:-/data/hdt/ntv_data/data/unrealzoo_robotdog_human_debug}"
...
Examples:
  ...
  bash precache_tracking_features.sh --data-root /data/hdt/ntv_data/data/sample_processed
  DATA_ROOT=/data/hdt/ntv_data/data/sample_processed bash precache_tracking_features.sh
