...
SIM_DATA_DIR="${SIM_DATA_DIR:-/data/hdt/ntv_data/sim_data/unrealzoo_robotdog_human_1k}"
...
Examples:
  ...
  bash run_robotdog_unrealzoo_pipeline.sh \
    --total 1000 \
    --sim-data /data/hdt/ntv_data/sim_data/robotdog_1k \
    --output /data/hdt/ntv_data/data/robotdog_1k
