...
EVAL_SUCCESS_RATE_THRESHOLD="${EVAL_SUCCESS_RATE_THRESHOLD:-0.5}" # 跟踪率达到该值才算成功。
...
# 目标人重放和初始状态。
EVAL_TARGET_REPLAY_MODE="${EVAL_TARGET_REPLAY_MODE:-nav_goal}"   # 可选 nav_goal 或 pose。
...
EVAL_HUMAN_SPEED="${EVAL_HUMAN_SPEED:-90}" # 目标人速度
...
EVAL_ROBOTDOG_IDEAL_FOLLOW_DIST="${EVAL_ROBOTDOG_IDEAL_FOLLOW_DIST:-2.2}"
EVAL_ROBOTDOG_MIN_FOLLOW_DIST="${EVAL_ROBOTDOG_MIN_FOLLOW_DIST:-1.0}"
EVAL_ROBOTDOG_MAX_FOLLOW_DIST="${EVAL_ROBOTDOG_MAX_FOLLOW_DIST:-4.0}"
