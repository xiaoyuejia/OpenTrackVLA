...
#   --seed              随机种子 (默认: 100)
#   --output            输出目录 (默认: /data/hdt/ntv_data/data/sample)
...
NUM_PARALLEL=1
SEED=100
OUTPUT_DIR="/data/hdt/ntv_data/data/sample"
SIM_DATA_DIR="/data/hdt/ntv_data/sim_data/stt_traintest"
INSTRUCTION="Follow the target person without collision."
# 数据筛选参数 (新增)
MIN_FOLLOWING_RATE=0.0
