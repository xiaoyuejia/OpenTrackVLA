...
new6_output=/data/hdt/ntv_data/sim_data/keyboard_collect_inverse_replay_m40_m8_speed100_gpu4_new6
runtime=/data/hdt/ntv_data/sim_data/unreal_env_workers/gpu5
...
export MPLCONFIGDIR=/tmp/matplotlib-replay-gpu5-12h

run_batch_maps_except_korean_palace new6 "$new6_output"
run_batch_maps_except_korean_palace new6 "$new6_output"
