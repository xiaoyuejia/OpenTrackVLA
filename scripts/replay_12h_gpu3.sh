...
new9_output=/data/hdt/ntv_data/sim_data/keyboard_collect_inverse_replay_m40_m8_speed100_gpu3_new9
runtime=/data/hdt/ntv_data/sim_data/unreal_env_workers/gpu3
...
export MPLCONFIGDIR=/tmp/matplotlib-replay-gpu3-12h

run_batch_maps_except_korean_palace new9 "$new9_output"
