...
INPUT_ROOT="${INPUT_ROOT:-sim_data/unrealzoo_robotdog_human_debug}"
OUTPUT_ROOT="${OUTPUT_ROOT:-data/unrealzoo_robotdog_human_debug}"
HISTORY="${HISTORY:-31}"
HORIZON="${HORIZON:-8}"
DT="${DT:-0.1}"
...
Examples:
  ...
  bash process_tracking_data.sh --input sim_data/sample --output data/sample_processed
  INPUT_ROOT=sim_data/sample OUTPUT_ROOT=data/sample_processed bash process_tracking_data.sh
