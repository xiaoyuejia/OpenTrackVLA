...
def forward_multi_agent_loss(
    ...
    return loss, {
        ...
        "val_xy_mse_drone": xy_per_agent[:, 0].mean().detach(),
        "val_xy_mse_robotdog": xy_per_agent[:, 1].mean().detach(),
        "val_yaw_mse_drone": yaw_per_agent[:, 0].mean().detach(),
        "val_yaw_mse_robotdog": yaw_per_agent[:, 1].mean().detach(),
        "val_final_waypoint_error_drone": final_per_agent[:, 0].mean().detach(),
        "val_final_waypoint_error_robotdog": final_per_agent[:, 1].mean().detach(),
