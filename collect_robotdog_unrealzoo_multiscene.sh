...
OUT_DIR="${OUT_DIR:-/data/hdt/newtrackvla/sim_data/unrealzoo_robotdog_human_1k}"
...
Examples:
  ...
  TOTAL_EPISODES=1000 OUT_DIR=/data/hdt/newtrackvla/sim_data/robotdog_1k bash collect_robotdog_unrealzoo_multiscene.sh
